...
<a class='anchor' id='Data-Types'></a><h2>Data Types</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#data-types' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
...
<a class='anchor' id='Database-Management'></a><h2>Database Management</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#database-management' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
<ul>
...
<a class='anchor' id='Table-Management'></a><h2>Table Management</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#table-management' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
<ul>
...
<p>Note: </p>
<p>1) The first column must be a <code>timestamp</code>, and the system will set it as the primary key.</p>
<p>2) The record size is limited to 4096 bytes</p>
<p>3) For <code>binary</code> or <code>nchar</code> data types, the length must be specified. For example, binary(20) means a binary data type with 20 bytes.</p></li>
...
<p>It shows all tables in the current DB. </p>
<p>Note: Wildcard characters can be used in the table name to filter tables. 
Wildcard characters: 
1) ’%’ means 0 to any number of characters. 
2）’_’ underscore means exactly one character.</p></li>
...
<p><strong>Tips</strong>: You can apply an operation on a table not in the current DB by concatenating DB name with the character '.', then with the table name. For example, 'demo.tb1' means the operation is applied to table <code>tb1</code> in DB <code>demo</code> even though <code>demo</code> is not the currently selected DB.   </p>
<a class='anchor' id='Inserting-Records'></a><h2>Inserting Records</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#inserting-records' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
<ul>
...
<p>Insert multiple data records into the table</p></li>
...
<p>Note: 1. For a table, the new record must have a timestamp bigger than the last data record, otherwise, it will be discarded and not inserted. If the timestamp is 0, the time stamp will be set to the system time on the server.
      2.The timestamp of the oldest record allowed to be inserted is relative to the current server time, minus the configured keep value (the number of days the data is retained), and the timestamp of the latest record allowed to be inserted is relative to the current server time, plus the configured days value (the time span in which the data file stores data, in days). Both keep and days can be specified when creating the database. The default values are 3650 days and 10 days, respectively.</p>
<p><strong>IMPORT</strong>: If you do want to insert a historical data record into a table, use IMPORT command instead of INSERT. IMPORT has the same syntax as INSERT. </p>
<a class='anchor' id='Data-Query'></a><h2>Data Query</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#data-query' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
...
<li>For filtering, only a single range is supported. For example, <code>value&gt;20 and value&lt;30</code> is a valid condition, but <code>value&lt;20 AND value&lt;&gt;5</code> is an invalid condition</li>
</ol>
...
<a class='anchor' id='SQL-Functions'></a><h2>SQL Functions</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#sql-functions' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
...
Return Data Type: <code>integer</code>.<br />
Applicable Data Types: all.<br />
Applied to: table/STable.<br />
Note: </p>
<p>1) <code>*</code> can be used for all columns, as long as a column has non-NULL values, it will be counted.</p>
<p>2) If it is on a specific column, only rows with non-NULL values will be counted </p></li>
...
Return Data Type: <code>double</code>.<br />
Applicable Data Types: all types except <code>timestamp</code>, <code>binary</code>, <code>nchar</code>, <code>bool</code>.<br />
...
Return Data Type: <code>long integer</code> or <code>double</code>.<br />
Applicable Data Types: all types except <code>timestamp</code>, <code>binary</code>, <code>nchar</code>, <code>bool</code>.<br />
Applied to: table/STable. </p></li>
...
<p>Function: returns the standard deviation of a specific column.<br />
...
Applied to: table/STable.<br />
Note: 
1) Valid range of <code>k</code>: 1≤<em>k</em>≤100
2) The associated <code>timestamp</code> will be returned too.  </p></li>
...
Return Data Type: the same data type.<br />
Applicable Data Types: all types except <code>timestamp</code>, <code>binary</code>, <code>nchar</code>, <code>bool</code>. 
Applied to: table/STable.<br />
...
Applicable Data Types: all types.<br />
Applied to: table/STable.<br />
Note: different from last, last_row returns the last row even if it has NULL values. </p></li>
</ul>
...
<a class='anchor' id='Downsampling'></a><h2>Downsampling</h2><a href='https://github.com/taosdata/TDengine/blob/develop/documentation/webdocs/markdowndocs/TAOS%20SQL.md#downsampling' class='edit-link'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width='24' height='24'><path d='M64 368v80h80l235.727-235.729-79.999-79.998L64 368zm377.602-217.602c8.531-8.531 8.531-21.334 0-29.865l-50.135-50.135c-8.531-8.531-21.334-8.531-29.865 0l-39.468 39.469 79.999 79.998 39.469-39.467z'/></svg></a>
...
</ol></section></main></div><?php include($s.'/footer.php'); ?><script>$('pre').addClass('prettyprint linenums');PR.prettyPrint()</script><script src='/lib/docs/liner.js'></script></body></html>