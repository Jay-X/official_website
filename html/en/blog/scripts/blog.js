  ...
  */
  ...
  Promise.all(allPromisesForPosts).then(function (values) {
    ...
    */
    ...
    if (isNaN(totalPages)) {
      $('.blank-placeholder-posts').css('display', 'none');
      $("#posts-list").append("<h3>No posts returned, click <a l href='../blog'>here</a> to go back to the blog home page</h3>");
      return;
    }
    ...
    if (posts.length > 0) {
      ...
      if (page > 1 && totalPages != 1) {
        ...
        $("#pagination").append("<a class='page-num' id='page-" + (page - 1) + "' href='?" + objectToParams(addPageParams) + "'><button class='btn btn-primary'>Prev</button></a>");
      }
      ...
      if (page < totalPages && totalPages != 1) {
        ...
        $("#pagination").append("<a class='page-num' id='page-" + (page + 1) + "' href='?" + objectToParams(_addPageParams) + "'><button class='btn btn-primary'>Next</button></a>");
      }
